...
- Also has immense importance for inclusive and sustainable world development 
...
2. **Transforming** Achievement of Different Int’l Tests onto the PISA Scale (Layers 2+3) `r fontawesome::fa('long-arrow-alt-right')` up next
...
- Consideration of full underlying achievement distributions provides common support at student level
  ...
  - Previous transformation methods based on linear extrapolation from country mean scores tend to overestimate these countries’ achievement

<img src="index/kdensity_pasec_pisa_w_line221002.png" width="40%"/>
<img src="index/kdensity_pasec_w_line221002.png" width="40%"/>

[Comparison to Estimates based on Alternative Methods](#alternative)
---
...
- Cognitive ability test is not the same as the PISA achievement test: assuming a similar regional distributions of ability and achievement provides a way to directly estimate skills across the country. 
...
2. The share of children not reaching basic skills **exceeds half in 101 countries** and rises **above 90% in 37** of these countries. 
...
4. Skill deficits reach **94% in Sub-Saharan Africa** and **90% in South Asia** but also hit 70% in Middle East and North Africa and 66% in Latin America. 
...
### 1. School reform $(\tau = 1, …, R)$
- During the reform period R, workers with the initial skill level in the economy are being replaced by progressively more skilled workers

### 2. Main replacement $(\tau= R+1, …, W)$
- Workers of the original skill level will be replaced by the new higher-skilled workers for the next (W-R) years (W = length of work life) 

###3. Quality consolidation $(\theta = W+1, …, W+R)$
- For the next R years, some of the variable quality workers educated during the reform period are replaced by the highest skill workers

### 4. Completely high skilled $(\tau = W+R+1, …)$
- The economy is constant quality at higher level
...
-  94 % in Sub-Saharan Africa and 90 % in South Asia
