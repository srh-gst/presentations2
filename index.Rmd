...
- Most studies look at impact of natural disasters on economic growth in cross country analysis (eg. Dell, Jones and Olken 2012) but there is less attention on the impact on students.
...
- Data: Combining county level student achievement (SEDA) with disaster declarations in the US from the Federal Emergency Management Agency (FEMA) (2009-2018).
- Framework:  I estimate the effect of a natural disaster on student achievements in a TWFE frame-work.
...
- The disaster declaration includes the date the disaster was declared, the area, the type of incident, denotes which assistance programme was declared. 
...
where $Disaster_{i,t}$ is the number and severity of a natrual disasters in the past 5 years in a county and year, $\alpha_i$  and $\lambda_t$ are county and year fixed effects, $\mathbf{X}_i \lambda_t$ includes an interaction between initial county population and a linear time trend. 
...
- Evidence points to s negative effect of natural disaster on student achievement in the year of the natural disaster.
